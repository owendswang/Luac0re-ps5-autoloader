...
Added autoloader for PS5 to Luac0re. Autoloader function is inspired from [itsPLK/ps5_lua_autoloader](https://github.com/itsPLK/ps5_lua_autoloader).
...
- P2JB payload requires 12.70 or lower firmware PS5
